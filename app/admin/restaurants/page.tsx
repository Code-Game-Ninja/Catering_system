                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <p>
                          <span className="font-medium">Created:</span> {restaurant.createdAt ? (typeof restaurant.createdAt === 'object' && typeof restaurant.createdAt.toDate === 'function' ? restaurant.createdAt.toDate().toLocaleDateString() : new Date(restaurant.createdAt as any).toLocaleDateString()) : 'N/A'}
                        </p>
                      </div>
                    </div>
